...
vi.mock('@/api/endpoints/coupons', () => ({
  couponsApi: {
    list: vi.fn().mockResolvedValue({
      coupons: [
        { id: 1, code: 'KDF-AAAA0001', name: 'Summer Sale', type: 'PERCENTAGE', value: 10, min_order_amount: 1000, usage_limit: 100, per_user_limit: 1, usage_count: 5, platform: null, valid_from: '2024-01-01', valid_to: '2024-12-31', is_active: 1, created_at: '2024-01-01T00:00:00Z' },
        { id: 2, code: 'KDF-BBBB0002', name: 'Free Ship', type: 'FREE_SHIPPING', value: 0, min_order_amount: 3000, usage_limit: 50, per_user_limit: 2, usage_count: 10, platform: 'TIKTOK', valid_from: '2024-02-01', valid_to: '2024-06-30', is_active: 1, created_at: '2024-02-01T00:00:00Z' },
      ],
      total: 2,
    }),
